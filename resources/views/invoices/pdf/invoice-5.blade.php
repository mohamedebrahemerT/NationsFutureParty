                ...
                <td>
                    <table class="text-black mt-1 f-13 b-collapse rightaligned">
                        ...
                        <tr>
                            ...
                            <td class="heading-table-right">{{ $invoice->issue_date->format(global_setting()->date_format) }}
                            </td>
                        </tr>
                        @if (empty($invoice->order_id) && $invoice->status === 'unpaid' && $invoice->due_date->year > 1)
                            <tr>
                                <td class="heading-table-left">@lang('app.dueDate')</td>
                                <td class="heading-table-right">{{ $invoice->due_date->format(global_setting()->date_format) }}
                                </td>
                            </tr>
                        @endif
                    </table>
