...
class FetchTicketEmails extends Command
{
    ...
    public function handle()
    {
        ...
        if ($this->ticketEmailSetting->status == 1) {
            ...
            Config::set('imap.accounts.default.host', $this->ticketEmailSetting->mail_host);
            Config::set('imap.accounts.default.port', $this->ticketEmailSetting->mail_port);
            Config::set('imap.accounts.default.encryption', $this->ticketEmailSetting->mail_encryption);
