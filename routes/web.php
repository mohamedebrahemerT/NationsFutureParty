...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    Route::get('shifts/request-change/{id}', [EmployeeShiftScheduleController::class, 'requestChange'])->name('shifts.request_change');
    Route::post('shifts/request-change/{id}', [EmployeeShiftScheduleController::class, 'requestChangeSubmit'])->name('shifts.request_change');
