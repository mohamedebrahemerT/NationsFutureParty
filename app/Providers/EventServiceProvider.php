...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        'App\Events\ContractSignedEvent' => ['App\Listeners\ContractSignedListener'],
        'App\Events\EmployeeShiftScheduleEvent' => ['App\Listeners\EmployeeShiftScheduleListener'],
        'App\Events\EmployeeShiftChangeEvent' => ['App\Listeners\EmployeeShiftChangeListener'],
    ];
}
