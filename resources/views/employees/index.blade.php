        ...
        <div class="d-flex justify-content-between action-bar">
            ...
            <div id="table-actions" class="d-block d-lg-flex align-items-center">
                ...
                @if ($addDesignationPermission == 'all' || $addDesignationPermission == 'added')
                    <x-forms.button-secondary class="mr-3 mb-2 mb-lg-0" icon="plus" id="designation-setting">
                        @lang('app.add') @lang('app.designation')
                    </x-forms.button-secondary>
                @endif

                @if ($addDepartmentPermission == 'all' || $addDepartmentPermission == 'added')
                    <x-forms.button-secondary class="mr-3 department-setting mb-2 mb-lg-0" icon="plus">
