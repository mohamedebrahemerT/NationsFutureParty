...
<div class="modal-body bg-grey">
    ...
    <div class="row">
        <div class="col-md-6">
            <x-cards.data :title="__('app.date').' - '.$startTime->format(global_setting()->date_format)">
                            ...
                            <ul class="res-activity-list col-md-9">
                                <li>
                                    ...
                                    <p class="res-activity-time">
                                        ...
                                        {{ $item->clock_in_time->timezone(global_setting()->timezone)->format(global_setting()->time_format) }}
                                ...
                                <li>
                                    ...
                                    <p class="res-activity-time">
                                        ...
                                        @if (!is_null($item->clock_out_time))
                                            {{ $item->clock_out_time->timezone(global_setting()->timezone)->format(global_setting()->time_format) }}
                                        @else
                                            @lang('modules.attendance.notClockOut')
                                        @endif
                                    </p>
